...
<%--                <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>--%>
                   <asp:TextBox ID="MessageTextBox" TextMode="MultiLine" Columns="50" Rows="5" class="form-control" placeholder="Please write something for us" runat="server"></asp:TextBox>
