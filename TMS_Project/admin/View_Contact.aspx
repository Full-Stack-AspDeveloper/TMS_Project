...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-center text-light bg-dark jumbotron">View Contact Details</h1>
        </div>
    </div>

    <asp:GridView CssClass="table table-bordered table-hover table-striped table-dark table-light" ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Name">
                <ItemTemplate>
                    <asp:Label ID="LabelIName" runat="server" Text='<%# Bind("name") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Mssage">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Delete" ShowHeader="False">
                ...
                <ControlStyle CssClass="btn btn-danger text-light" />
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
